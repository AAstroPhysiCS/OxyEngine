...
public final class OpenGLCubeTexture extends CubeTexture {
    ...
    OpenGLCubeTexture(TextureSlot slot, int width, int height, TexturePixelType pixelType, TextureFormat format, TextureParameterBuilder.POpenGL parameter) {
        ...
        if(parameter.minFilterParameter != null) glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, parameter.minFilterParameter.apiValue);
        if(parameter.magFilterParameter != null) glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER, parameter.magFilterParameter.apiValue);
        if(parameter.wrapSParameter != null) glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_S, parameter.wrapSParameter.apiValue);
        if(parameter.wrapRParameter != null) glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_R, parameter.wrapRParameter.apiValue);
        if(parameter.wrapTParameter != null) glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_T, parameter.wrapTParameter.apiValue);
