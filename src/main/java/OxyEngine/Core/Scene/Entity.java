...
public final class Entity {
    ...
    Entity(Entity other) {
        ...
        if (other.has(PointLight.class)) {
            this.addComponent(new PointLight(other.get(PointLight.class)));
            Renderer.submitPointLight(this.get(PointLight.class));
        }
        if (other.has(DirectionalLight.class)) {
            this.addComponent(new DirectionalLight(other.get(DirectionalLight.class)));
            Renderer.submitDirectionalLight(this.get(DirectionalLight.class));
        }
        ...
        if (other.has(OpenGLMesh.class)) {
            ...
            Renderer.submitMesh(this.get(OpenGLMesh.class), this.get(TransformComponent.class), this.get(AnimationComponent.class));
        }
